            ...
            <div class="option__container row">
              <div class="option__1 col">
                ...
                <div class="mb-3">
                  ...
                  <input name = "fname" type="text" class="form-control" value = "${customer.firstname}" required>
                </div>
                <div class="mb-3">
                  <label class="form-label"><span>*</span>Last Name</label>
                  <input name = "lname" type="text" class="form-control"  value = "${customer.lastname}" required>
                </div>
                <div class="mb-3">
                  <label class="form-label"><span>*</span>Phone Number</label>
                  <input name = "phone" type="number" class="form-control" value = "${customer.phone}" required>
                </div>
              ...
              <div class="option__2 col">
                ...
                <div class="mb-3">
                  ...
                  <input name = "address" type="text" class="form-control" placeholder="Enter your Address here!" required>
                </div>
                <div class="mb-3">
                  <label class="form-label"><span>*</span>Road</label>
                  <input name = "road" type="text" class="form-control" placeholder="Enter your Road Name here!" required>
                </div>
                <div class="mb-3">
                  <label class="form-label"><span>*</span>Ward</label>
                  <input name = "ward" type="text" class="form-control" placeholder="Enter your Ward here!" required>
                </div>
                <div class="mb-3">
                  <label class="form-label"><span>*</span>District</label>
                  <input name = "district" type="text" class="form-control" placeholder="Enter your District here!" required>
                </div>
                <div class="mb-3">
                  <label class="form-label"><span>*</span>City</label>
                  <input name = "city" type="text" class="form-control" placeholder="Enter your City here!" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <a style="float: right; margin-top: 15px;" type="button" class="login__btn">CONTINUE</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
        ...
        <div class="accordion-body">
          ...
          <div class="form-check mb-3">
            <a style="float: right;" type="button" class="login__btn">CONTINUE</a>
          </div>
        </div>
      </div>
    </div>
