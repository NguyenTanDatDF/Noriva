        ...
        <div id="content" class=" p-md-5 pt-5">
            <div class="about__us__container">
                ...
                <div class="about__us__paragraph">
                    <div class="about__us__paragraph__text">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" placeholder="Enter your First Name here!" required name = "firstname">
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>Last Name</label>
                            <input type="text" class="form-control" placeholder="Enter your Last Name here!" required name = "lastname">
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>Birthday</label>
                            <input type="date" class="form-control" placeholder="Enter your Telephone here!" required name = "birthday">
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>Telephone</label>
                            <input type="number" class="form-control" placeholder="Enter your Telephone here!" required name = "phone">
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>Email</label>
                            <input type="email" class="form-control" placeholder="Enter your Email here!" required name = "email">
                        </div>
                        <legend>Your Account Details</legend>
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>Username</label>
                            <input type="text" class="form-control" placeholder="Enter your Username here!" required name = "username">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="container">   
                            <input type = "submit" class="btnn float-end" value = "Save Changes" >
                        </div>
                ...
                <form action = "LoginForward">
                   <div class="container">
                            <input type = "submit" class="btnn float-end" value = "Back" >
                        </div>
                        </form>
            </div>
        </div>
