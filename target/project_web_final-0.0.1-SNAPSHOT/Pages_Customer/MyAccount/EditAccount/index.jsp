...
<head>
    ...
    <link rel="stylesheet" href="./Pages_Customer/MyAccount/EditAccount/style.css">
</head>
    ...
    <div class="d-md-flex align-items-stretch">
        ...
        <div id="content" class=" p-md-5 pt-5">
            <div class="about__us__container">
                ...
                <form action = "EditAccountController">
                    <div class="about__us__paragraph__text">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name = "birthday" class="form-control"  value = "${customer.birthday}" required>
                        </div>
                        <div class="mb-3">
...
<script src="/Customer_Page/Pages/MyAccount/EditAccount/main.js"></script>
