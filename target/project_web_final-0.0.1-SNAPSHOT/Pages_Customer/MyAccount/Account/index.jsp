...
<head>
    ...
    <link rel="stylesheet" href="./Pages_Customer/MyAccount/Account/style.css">
</head>
            ...
            <div class="about__us__container">
                <div class="about__us__paragraph">
                    <div class="about__us__paragraph__text">
                        ...
                        <a class="mb-3" href="EditAccountForward">Edit your account information</a>
                        <br>
                        <a href="ChangePasswordForward">Change your password</a> 
                         <br>
                         <a href="LogoutController">Log out</a>
                        <h1 class="mt-3 mb-3">My Orders</h1>
                        <a href="OrderHistoryForward">View your order history</a>
                    </div>
                </div>
            </div>
        </div>
...
<script src="/Customer_Page/Pages/MyAccount/Account/main.js"></script>
