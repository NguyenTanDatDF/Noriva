        ...
        <div class="accordion-body container">
          <div class="option__container row">
            <div class="option__1 col">
              ...
              <br>
              <a class="register__btn" href="/customer/my-account/register">Register</a>
            </div>
            <div class="option__2 col">
              ...
              <div class="mb-3">
                ...
                <input name = "user" type="text" class="form-control" placeholder="Enter your Username here!" required>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <input type="submit" class="login__btn" value ="Login">
              </div>
              </form>
            </div>
          </div>
            ...
            <div class="option__container row">
              ...
              <div class="option__2 col">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Enter your Road Name here!" required>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="Enter your District here!" required>
                </div>
                <div class="mb-3">
