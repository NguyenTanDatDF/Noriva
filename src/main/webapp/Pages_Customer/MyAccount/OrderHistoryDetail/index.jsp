...
<head>
    ...
    <link rel="stylesheet" href="./Pages_Customer/MyAccount/OrderHistoryDetail/style.css">
</head>
                ...
                <div class="about__us__paragraph">
                    <div class="about__us__paragraph__text">
                        ...
                        <table class="table table-bordered mb-5">
                            ...
                            <tbody>
                              <tr>
                                <td>Avengers Business Company</td>
                                <td>${bill.address} ${bill.road} ${bill.ward} ${bill.district} ${bill.city} ${bill.country}   </td>
                              </tr>
                            </tbody>
                          </table>
...
<script src="./Customer_Page/Pages/MyAccount/OrderHistoryDetail/main.js"></script>
