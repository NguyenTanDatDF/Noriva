...
<head>
    ...
    <link rel="stylesheet" href="./Pages_Customer/MyAccount/ChangePassword/style.css">
</head>
            ...
            <div class="about__us__container">
                ...
                <div class="about__us__paragraph">
                    ...
                    <form action = "ChangePasswordController" method = "post"> 
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>Old Password</label>
                            <input type="password" name = "old" class="form-control" placeholder="Enter your password here!"
                                required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label"><span>*</span>New Password</label>
                            <input type="password" name = "new" class="form-control" placeholder="Enter your password here!"
                                required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="container">
                            ...
                            <button class="btnn float-end">Save changes</button>
                        </div>
                        </form>
                       <div class="container">
                            <button class="btnn float-start">Back</button>
...
<script src="./Customer_Page/Components/AccountSideBar/AccountSideBarMain.js"></script>
<script src="./Components_Customer/Footer/Footer.js"></script>
<script src="./Components_Customer/Header/Header.js"></script>
<script src="/Customer_Page/Pages/MyAccount/ChangePassword/main.js"></script>
