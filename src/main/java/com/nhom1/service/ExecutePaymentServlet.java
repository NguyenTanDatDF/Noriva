		...
		try {
			...
			request.setAttribute("transaction", transaction);			
			 ...
			 HttpSession sessionz = request.getSession(false);
		       ...
		       mail.Send(email, "Thank you for your purchase!", "Your products will be shipped to "+ final_address +", Please prepare an amount of "+ Integer.toString(Integer.parseInt(total) + Integer.parseInt(ship_fee)) +  " dollars. Best regards");			
